...
class TenantBase(BaseModel):
    ...
    tenant_id: UUID = Field(
        ...,
        description="Unique identifier for the tenant this record belongs to"
    )
...
class APIKeyBase(BaseModel):
    ...
    tenant_id: UUID = Field(
        ...,
        description="UUID of the tenant this key belongs to"
    )
    key_hash: str = Field(
        ...,
        min_length=64,
        max_length=64,
        description="SHA256 hash of the actual API key"
    )
    prefix: str = Field(
        ...,
        min_length=8,
...
class UsageRecord(BaseModel):
    ...
    tenant_id: UUID = Field(
        ...,
        description="UUID of the tenant consuming resources"
    )

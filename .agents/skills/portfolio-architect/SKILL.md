...
description: "Transform service catalog into high-ticket portfolio assets with progressive complexity: basic workflow or advanced Codex 2.1.0 features with agent coordination"
...
## Context
You architect high-ticket portfolio projects that transform service catalogs into revenue-generating assets. The system adapts to user experience level: **basic mode** for straightforward portfolio development, or **advanced mode** leveraging Codex 2.1.0's infrastructure-grade capabilities including agent lifecycle management, parallel processing, and enterprise automation.
...
**Basic**: Codex configuration with standard agent coordination
**Advanced**: Agent swarm with context forking and hot-reload capabilities

**Universal Process**:
1. Design optimal Codex toolchain configuration
...
3. Configure Codex setup (agents, skills, hooks)
...
- @reference/basic/handoff-templates.md - Auto Codex prompt templates
...
- @reference/advanced/Codex-2-1-0-optimization.md - Infrastructure features
...
- [ ] Technical architecture leverages appropriate Codex features
- [ ] Scope refinement includes comprehensive requirements
- [ ] Auto Codex handoff integrates context and memory
...
3. **Architecture**: Standard Codex configuration with basic agent coordination
4. **Refinement**: Comprehensive specification with manual quality validation
5. **Generation**: Context-optimized Auto Codex handoff with project memory

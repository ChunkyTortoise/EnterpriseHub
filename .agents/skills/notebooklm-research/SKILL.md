...
2. Add AGENTS.md and related docs as sources
...
**Problem**: Tools not appearing in Codex

**Solution**:
```bash
# Restart Codex after editing .mcp.json
...
- [MCP Server Implementation](.Codex/mcp-servers/notebooklm/server.py)

...
class CommissionCalculator:
    ...
    def get_pipeline_summary(self, active_only: bool = True) -> Dict:
        ...
        return {
            ...
            "weighted_close_rate": round((total_expected / total_potential * 100) if total_potential > 0 else 0, 1),
            "by_stage": by_stage,
    ...
    def get_automation_roi_report(self) -> Dict:
        ...
        if "top_features" in automation_impact:
            for feature_data in automation_impact["top_features"]:
                ...
                feature_breakdown.append({
                    ...
                    "estimated_value": round(revenue_increase * (feature_data["count"] / automation_impact["deals_using_automation"]), 2)
                })
        ...
        return {
            ...
            "payback_period_days": round((system_cost_annual / revenue_increase * 365) if revenue_increase > 0 else 999, 0),

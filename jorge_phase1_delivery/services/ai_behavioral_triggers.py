...
class BehavioralTriggerEngine:
    ...
    def _check_price_sensitivity(self, lead_id: str, events: List[BehavioralEvent]) -> Optional[FiredTrigger]:
        ...
        property_views = [
            e for e in events 
            if e.event_type == "property_view" and "price" in e.data
        ]
...
if __name__ == "__main__":
    ...
    now = datetime.now()
    events = [
        BehavioralEvent("property_view", "lead_456", now - timedelta(hours=1), {"price": 500000}, "web"),
        BehavioralEvent("property_view", "lead_456", now - timedelta(minutes=45), {"price": 450000}, "web"),
        BehavioralEvent("calculator_use", "lead_456", now - timedelta(minutes=30), {"type": "mortgage"}, "web"),
        BehavioralEvent("property_view", "lead_456", now - timedelta(minutes=15), {"price": 420000}, "web"),
        BehavioralEvent("property_save", "lead_456", now - timedelta(minutes=5), {"property_id": "prop_123"}, "web"),
    ]

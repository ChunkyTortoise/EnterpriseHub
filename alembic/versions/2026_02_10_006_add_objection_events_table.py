...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("objection_type", sa.String(50), nullable=False, index=True, comment="Specific objection type (e.g., pricing_general, timing_not_ready)"),
        sa.Column("objection_category", sa.String(50), nullable=False, index=True, comment="High-level category: pricing, timing, competition, trust, authority, value"),
        ...
        sa.Column("graduation_level", sa.String(50), nullable=False, comment="Response level: validate, data, social_proof, market_test"),
        sa.Column("response_variant", sa.Integer(), nullable=False, server_default="0", comment="A/B test variant index"),
        sa.Column("response_text", sa.Text(), nullable=True, comment="Actual response text sent to contact"),
        sa.Column("outcome", sa.String(50), nullable=True, comment="resolved, unresolved, escalated, or null if pending"),
        sa.Column("outcome_timestamp", sa.DateTime(timezone=True), nullable=True, comment="When outcome was determined"),
        sa.Column("market_data", postgresql.JSONB(), nullable=True, comment="Market data used to fill response template"),

...
class StripeClient:
    ...
    async def create_customer(
        self, email: str, name: str, location_id: Optional[str] = None, metadata: Optional[Dict[str, str]] = None
    ) -> Dict[str, Any]:
        """
    ...
    async def create_subscription(
        ...
        try:
            ...
            idempotency_key = self._generate_idempotency_key("sub", f"{customer_id}:{plan_tier.value}")

...
Test priority: "Query Jorge's GHL leads and match with Austin properties"
...
```
"Use Firecrawl to find 2 Austin properties under $600k"
```

### **Step 5: Full Workflow Test (2 minutes)**
```
"Query Jorge's GHL for leads, find matching Austin properties, create follow-up plan using Sequential Thinking"
```
...
- **Firecrawl**: Returns Austin property listings with details
...
- Scrape current Austin property market

...
class WinProbabilityPredictor:
    ...
    async def predict_win_probability(
        ...
        features = self._extract_prediction_features(
            seller_psychology, market_leverage, negotiation_strategy, 
            property_data, buyer_profile
        )
        ...
        confidence_interval = self._calculate_confidence_interval(
            strategy_adjusted_probability, features
        )
        ...
        optimal_analysis = await self._analyze_optimal_offer_scenarios(
            features, negotiation_strategy, property_data
        )
    ...
    def _encode_market_condition(self, condition: MarketCondition) -> int:
        ...
        encoding = {
            MarketCondition.BUYERS_MARKET: 1,
            MarketCondition.BALANCED: 2,
            MarketCondition.SELLERS_MARKET: 3
        }
    ...
    async def _analyze_optimal_offer_scenarios(
        ...
        return {
            ...
            "current_offer_analysis": {
                ...
                "position_vs_optimal": "optimal" if abs(features.offer_to_list_ratio - optimal_value_scenario["offer_percentage"]/100) < 0.01 else "suboptimal"
            }
        }

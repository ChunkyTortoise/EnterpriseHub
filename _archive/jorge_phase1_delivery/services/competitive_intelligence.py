...
if __name__ == "__main__":
    ...
    competitive_lead = {
        ...
        'conversations': [
            ...
            {'sender': 'agent', 'message': 'That\'s smart to compare. What made you reach out to us too?'},
            {'sender': 'lead', 'message': 'They said 60 days to close. You mentioned 7 days?'},
        ],
        'metadata': {
            'score': 8.2,
            'urgency': 'high',
            'mentioned_lower_price': False
        }
    }

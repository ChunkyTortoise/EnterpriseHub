...
class HotLeadFastLane:
    ...
    def _score_intent_signals(self, signals: List[str]) -> float:
        ...
        # High-intent signals
        high_signals = {
            "pre_approved", "viewing_scheduled", "asked_about_offer",
            "requested_disclosure", "discussed_financing", "brought_inspector"
        }
        
        medium_signals = {
            "multiple_viewings", "asked_detailed_questions", "researched_neighborhood",
            "compared_properties", "requested_cma", "engaged_with_content"
        }
        
        low_signals = {
            "opened_email", "clicked_listing", "downloaded_guide",
            "attended_open_house", "signed_up", "requested_info"
        }
    ...
    test_leads = [
        {
            ...
            "timeline_days": 30,
            "engagement_score": 85,
            "intent_signals": ["pre_approved", "viewing_scheduled", "asked_about_offer"],
            "property_matches": 3,
            "source": "referral"
        },
        {

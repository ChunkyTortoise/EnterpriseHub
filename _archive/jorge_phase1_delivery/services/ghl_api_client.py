...
class GHLAPIClient:
    ...
    def add_contact_tag(self, contact_id: str, tag: str) -> Dict[str, Any]:
        """Add tag to contact"""
        return self._make_request("POST", f"/contacts/{contact_id}/tags", 
                                 json={"tags": [tag]})
    
    def remove_contact_tag(self, contact_id: str, tag: str) -> Dict[str, Any]:
        """Remove tag from contact"""
        return self._make_request("DELETE", f"/contacts/{contact_id}/tags", 
                                 json={"tags": [tag]})
    ...
    def get_appointments(self, calendar_id: str, 
    ...
    def update_appointment(self, appointment_id: str, 
        ...
        """Update appointment"""
        return self._make_request("PUT", f"/appointments/{appointment_id}", 

...
class WorkflowValidator:
    ...
    VALID_ACTIONS = [
        "send_sms", "send_email", "send_voice",
        "assign_agent", "update_lead", "add_tag",
        "create_task", "schedule_appointment",
...
if __name__ == "__main__":
    ...
    valid_workflow = {
        ...
        "steps": [
            {"action": "send_sms", "contact_id": "123", "message": "Hello", "delay_minutes": 0},
            {"action": "add_tag", "contact_id": "123", "tag": "contacted", "delay_minutes": 60}
        ]
    }

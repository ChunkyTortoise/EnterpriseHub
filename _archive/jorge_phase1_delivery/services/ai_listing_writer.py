...
class AIListingWriterService:
    ...
    def generate_listing(
        ...
        if include_seo:
            listing['seo_keywords'] = self._generate_seo_keywords(
                property_data, style
            )
    ...
    def _load_style_templates(self) -> Dict[str, Any]:
        ...
        return {
            'professional': {
                ...
                'closing': ['Schedule your showing today', 'Don\'t miss this opportunity']
            },
            'luxury': {
                'opening': ['Discover', 'Experience', 'Indulge in'],
                'closing': ['An extraordinary opportunity', 'Schedule your private tour']
            },
            'first_time_buyer': {
                'opening': ['Welcome home', 'Your dream starts here', 'Perfect for you'],
                'closing': ['Let\'s make your dream a reality', 'Start building equity today']
            }
        }

...
# For backward compatibility with Streamlit app
class RevenueAttributionService(RevenueAttributionEngine):
    """Wrapper for RevenueAttributionEngine to match expected API"""
    
    def get_attribution_data(self, location_id: str) -> Dict[str, Any]:
        """Alias for get_full_attribution_report"""
        return self.get_full_attribution_report(location_id)

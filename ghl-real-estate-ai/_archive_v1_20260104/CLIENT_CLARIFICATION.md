...
Jorge Salas - GHL Real Estate AI Qualification Assistant

Date: January 3, 2026
Status: Awaiting Client Direction
...
QUESTION 2: AI Engagement Trigger (for Path B)
...
QUESTION 3: AI Disengagement Trigger
...
QUESTION 4: Qualifying Questions

What specific information should the AI extract? (Check all that apply)
...
QUESTION 5: Lead Scoring Criteria

What makes a lead "Hot" vs "Cold"? (Pick one)
...
QUESTION 6: GHL Integration Details (for Path B)
...
QUESTION 7: Property Data Source
...
QUESTION 9: Response Format

How should the AI communicate with leads? (Check all that apply)
...
QUESTION 10: Testing & Deployment
...
QUESTION 11: Budget Clarification

You mentioned $150 total. Does this include: (Check all that apply)
...
If you confirm Path B:
   • Day 1: Set up FastAPI backend + GHL webhook

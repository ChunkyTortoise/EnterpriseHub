...
async def detect_life_event_triggers(contact_name: str, location: str) -> List[Dict[str, Any]]:
    ...
    triggers = [
        {"type": "Probate", "confidence": 0.82, "date_filed": "2025-11-10", "impact_on_sell_propensity": "High"},
        {"type": "Divorce", "confidence": 0.45, "date_filed": "2025-12-05", "impact_on_sell_propensity": "Medium"},
    ]

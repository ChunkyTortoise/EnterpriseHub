    ...
    async def predict_client_behavior(self,
        ...
        try:
            ...
            prediction = ClientBehaviorPrediction(
                ...
                predicted_budget_range=behavior_response.get('predicted_budget_range', {'min': Decimal('0'), 'max': Decimal('1000000')}),
    ...
    async def predict_deal_outcome(self,
        ...
        try:
            ...
            prediction = DealOutcomePrediction(
                ...
                predicted_final_price=Decimal(str(deal_response.get('predicted_final_price', 500000))),

...
class PropertyVisionAnalyzer:
    ...
    async def analyze_property_photo(
        ...
        try:
            ...
            analysis = await self._structure_analysis(
                vision_analysis,
                market_context,
                {
                    "location": location,
    ...
    async def _perform_vision_analysis(
        self, base64_image: str, location: Optional[Dict[str, float]], address: Optional[str], context: Optional[str]
    ) -> Dict[str, Any]:
        """
    ...
    def _build_vision_prompt(
        self, location: Optional[Dict[str, float]], address: Optional[str], context: Optional[str]
    ) -> str:
        """
...
"""
    ...
    async def _get_market_context(self, location: Optional[Dict[str, float]], address: Optional[str]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                ...
                "comparable_sales": [],
                "market_activity": {"active_listings": 0, "pending_sales": 0, "recent_sales_count": 0},
            }
    ...
    async def _structure_analysis(
        self, vision_data: Dict[str, Any], market_data: Dict[str, Any], metadata: Dict[str, Any]
    ) -> PropertyAnalysis:
        """
    ...
    def _generate_cache_key(
        self, image_data: bytes, location: Optional[Dict[str, float]], address: Optional[str]
    ) -> str:

    ...
    def _load_jorge_sequences(self) -> Dict:
        ...
        return {
            'buyer_sequence': [
                ...
                {'day': 7, 'message': 'One last check - should we keep looking for you?'}
            ],
            'seller_sequence': [
                {'day': 1, 'message': 'Quick update on market conditions in your area'},
                {'day': 3, 'message': 'Still thinking about selling or put it on hold?'},
                {'day': 7, 'message': 'Real talk - close your file or keep you active?'}
            ]
        }
...
if __name__ == "__main__":
    ...
    sample_lead = {
        ...
        'conversations': [
            {'sender': 'agent', 'message': 'Hey! Still interested?', 'timestamp': '2026-01-01T14:00:00'},
            {'sender': 'agent', 'message': 'Just checking in!', 'timestamp': '2026-01-02T10:00:00'},
        ],
        'metadata': {
            'name': 'Carlos',
            'location': 'Doral',

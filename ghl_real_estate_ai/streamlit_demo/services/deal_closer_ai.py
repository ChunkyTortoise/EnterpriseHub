...
Keep the response under 150 words and conversational."""
    ...
    def _extract_talking_points(self, category: str) -> List[str]:
        ...
        return talking_points.get(category, ["Understand your concerns", "Happy to discuss details", "Here to help"])
    ...
    def _suggest_follow_ups(self, category: str) -> List[str]:
        ...
        return follow_ups.get(category, ["Schedule follow-up call", "Send additional information", "Check in next week"])
    ...
    def analyze_deal_stage(self, lead_history: List[Dict]) -> Dict:
        ...
        if not lead_history:
            return {
                ...
                "recommendations": ["Send introduction email", "Schedule discovery call"]
            }
    ...
    def _get_stage_recommendations(self, stage: str, objections: List[Dict]) -> List[str]:
        ...
        recs = {
            "cold": ["Send warm introduction", "Share market insights", "Offer free CMA"],
            "discovery": ["Ask qualifying questions", "Understand needs and timeline", "Build rapport"],
            "qualification": ["Share relevant listings", "Discuss budget and financing", "Set showing schedule"],
            "objection_handling": ["Address concerns systematically", "Provide social proof", "Offer value demonstrations"],
            "closing": ["Review contract details", "Coordinate inspection", "Finalize financing"]
        }

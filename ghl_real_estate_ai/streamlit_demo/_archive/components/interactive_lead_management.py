...
def _generate_sample_leads_cached() -> Dict[str, "Lead"]:
    ...
    return {
        "lead_001": Lead(
            ...
            budget_min=400000,
            budget_max=450000,
            location_preference=["Fontana", "Ontario"],
        ...
        "lead_002": Lead(
            ...
            budget_min=350000,
            budget_max=400000,
            location_preference=["Ontario", "Upland"],
        ...
        "lead_003": Lead(
            ...
            budget_min=480000,
            budget_max=520000,
            location_preference=["Alta Loma", "Downtown"],
            property_type="Condo",
            timeline="Flexible",
            source="Social Media",
            contact_method=ContactMethod.EMAIL,
...
class InteractiveLeadManagement:
    ...
    def _generate_sample_properties(self) -> Dict[str, Property]:
        ...
        return {
            "prop_001": Property(
                id="prop_001",
                address="123 Oak Street, Fontana, CA",
                price=425000,
                bedrooms=4,
                bathrooms=2.5,
                square_feet=2400,
            ...
            "prop_002": Property(
                id="prop_002",
                address="456 Pine Avenue, Ontario, CA",
                price=395000,
                bedrooms=3,
                bathrooms=2.0,
                square_feet=2100,

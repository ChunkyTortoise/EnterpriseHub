            ...
            with st.form("login_form", clear_on_submit=False):
                ...
                with col1:
                    tenant_id = st.selectbox(
                        "🏢 Tenant",
                        ["demo", "enterprise", "trial"],
                        help="Select your organization tenant"
                    )
        ...
        try:
            ...
            mock_users = {
                ...
                ("manager@demo.com", "manager123", "demo"): {
                    ...
                    "permissions": [
                        Permission.READ_CUSTOMERS, Permission.UPDATE_CUSTOMERS, Permission.CREATE_CUSTOMERS,
...
if __name__ == "__main__":
    st.set_page_config(
        page_title="Authentication Demo",
        page_icon="🔐",
        layout="wide"
    )

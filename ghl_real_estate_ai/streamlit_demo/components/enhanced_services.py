...
def render_ai_lead_insights(lead_data):
    ...
    with col1:
        ...
        fig = go.Figure(go.Indicator(
            ...
            value=health_score,
            domain={'x': [0, 1], 'y': [0, 1]},
            title={'text': "ENGAGEMENT HEALTH", 'font': {'size': 12, 'color': '#8B949E', 'family': 'Space Grotesk'}},
    ...
    with col3:
        ...
        fig.update_traces(textposition='outside', textinfo='label+percent', textfont=dict(color='#FFFFFF', family='Space Grotesk'))

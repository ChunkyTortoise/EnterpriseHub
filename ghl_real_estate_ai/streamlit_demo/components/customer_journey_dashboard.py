...
class CustomerJourneyDashboard:
    ...
    def _render_stage_recommendations(self, stage_name: str):
        ...
        stage_recs = recommendations.get(stage_name, [
    ...
    def _generate_journey_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "flows": {
                "labels": ["Awareness", "Interest", "Consideration", "Evaluation", "Purchase", "Onboarding", "Adoption", "Advocacy"],
...
if __name__ == "__main__":
    st.set_page_config(
        page_title="Customer Journey Dashboard",
        page_icon="🗺️",
        layout="wide",

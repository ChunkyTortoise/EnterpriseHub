...
class VoiceAIInterface:
    ...
    def render_voice_controls(self, agent_id: str = "demo_agent") -> Dict[str, Any]:
        ...
        with col2:
            ...
            lead_id = st.text_input(
                "Lead ID (optional)",
                placeholder="LEAD_12345",
                help="Associate this conversation with a specific lead"
            )
            ...
            if not st.session_state.voice_session_active:
                if st.button("🎙️ Start Voice Session", type="primary", use_container_width=True):
                    self._start_voice_session(
                        agent_id,
                        interaction_types[selected_type],
    ...
    def render_live_interaction(self) -> None:
        ...
        with metrics_col:
            ...
            with col2:
                st.metric(
                    ...
                    "😊 Positive",
                    "+0.3",
                    help="Current conversation sentiment"
                )
        ...
        selected_input = st.selectbox(
            ...
            options=["Custom input..."] + demo_inputs,
            index=0
        )

        if selected_input == "Custom input...":
            voice_input = st.text_area(
                "Type what the client said:",
                placeholder="Enter simulated voice input...",
                height=100
            )
        else:
    ...
    def render_voice_analytics(self) -> Dict[str, Any]:
        ...
        with col1:
            st.metric(
                ...
                "47",
                "+12 this week",
                help="Total voice interactions this period"
            )
...
def render_voice_ai_interface(agent_id: str = "demo_agent") -> Dict[str, Any]:
    ...
    return {
        "session_active": session_status["session_active"],
...
if __name__ == "__main__":
    ...
    st.set_page_config(
        page_title="Voice AI Interface Test",
        page_icon="🎤",
        layout="wide"
    )

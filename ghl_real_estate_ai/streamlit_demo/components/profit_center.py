...
def render_profit_center():
    ...
    with col1:
        st.metric(
            ...
            f"${metrics['total_value_generated']:,.2f}",
    ...
    with col2:
        ...
        fig_agents = px.pie(agent_data, values="Value", names="Agent", 
    ...
    # Future Projections
    st.info("💡 **AI Insight**: Based on current lead velocity, the system is projected to generate an additional **$12,400** in value over the next 30 days.")

...
if __name__ == "__main__":
    st.set_page_config(
        page_title="Multi-Market Analytics",
        page_icon="🌍",
        layout="wide",
    ...
    **Geographic Performance Intelligence Center**
    ...
    with st.sidebar:
        ...
        metric_focus = st.selectbox(
            "Primary Metric",
            ["Conversion Rate", "Lead Volume", "Revenue", "Market Share", "Growth Rate"]
        )
    ...
    cross_market_flows = [f for f in cross_market_flows 
                         if f.source_market in selected_markets and f.target_market in selected_markets]

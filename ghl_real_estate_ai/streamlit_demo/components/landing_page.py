...
def render_landing_page():
    ...
    st.markdown(
        "<h2 style='text-align: center; font-size: 2.5rem; margin-bottom: 3rem;'>The Jorge Bot Ecosystem</h2>",
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        "<h2 style='text-align: center; font-size: 2.5rem; margin-bottom: 3rem;'>Enterprise-Grade Technical Infrastructure</h2>",
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        "<h2 style='text-align: center; font-size: 2.2rem; margin-bottom: 3rem;'>1,768+ Hours of Specialized AI/ML Training</h2>",
        unsafe_allow_html=True,
    )
    ...
    # 6. Offer Menu
    st.markdown(
        "<h2 style='text-align: center; font-size: 2.5rem; margin-bottom: 3rem;'>Ready to Scale Your Revenue?</h2>",
        unsafe_allow_html=True,
    )

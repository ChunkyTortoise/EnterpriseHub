...
class NegotiationIntelligenceDashboard:
    ...
    def render(self):
        ...
        # Dashboard tabs
        tab1, tab2, tab3, tab4 = st.tabs(["📊 Analysis", "🎯 Strategy", "💬 Real-Time Coaching", "📈 Performance"])
    ...
    def render_strategy_tab(self):
        ...
        with col3:
            st.metric("Win Probability", f"{analysis.win_probability.win_probability:.1f}%", delta="vs baseline")
    ...
    def render_coaching_tab(self):
        ...
        with col1:
            ...
            conversation_context = st.text_area(
                "Conversation Context", placeholder="Enter the current conversation details...", height=150
            )
            ...
            if st.button("🎯 Get Coaching", type="primary"):
                self.get_realtime_coaching(conversation_context, current_situation, buyer_feedback, seller_response)
    ...
    def render_quick_stats(self):
        ...
        st.metric("Processing Time", f"{analysis.processing_time_ms}ms", delta="sub-3-second target")
    ...
    def render_strategy_details(self, strategy):
        ...
        with col1:
            ...
            st.write(
                f"• **Relationship Approach:** {strategy.relationship_building_approach.replace('_', ' ').title()}"
            )
    ...
    def render_performance_trends(self):
        ...
        fig.add_trace(
            go.Scatter(
                x=trend_df["Date"], y=trend_df["Processing Time"], mode="lines", name="Processing Time (ms)", yaxis="y2"
            )
        )
        ...
        with st.spinner("🔄 Analyzing negotiation intelligence..."):
            try:
                request = NegotiationAnalysisRequest(
                    property_id=property_id, lead_id=lead_id, buyer_preferences=buyer_preferences
                )
    ...
    def get_realtime_coaching(
        self, conversation_context: str, current_situation: str, buyer_feedback: str, seller_response: str
    ):
        ...
        with st.spinner("🎯 Generating coaching..."):
            try:
                ...
                coaching_response = {
                    ...
                    "tactical_adjustments": ["Increase urgency emphasis", "Reference market comparables"],
                    "next_steps": [
            ...
            (),
            {
                ...
                "market_leverage": type(
                    ...
                    (),
                    {
                        ...
                        "inventory_levels": {"below_range": 4.2, "target_range": 6.8, "above_range": 8.5},
                    },
                )(),
                "negotiation_strategy": type(
                    "MockStrategy",
                    (),
                    {
                        ...
                        "offer_range": {"min": 705000, "target": 712500, "max": 720000},
                ...
                "win_probability": type(
                    ...
                    (),
                    {
                        ...
                        "risk_factors": [],
                        "success_drivers": ["High seller urgency", "Strong market leverage", "Property overpriced"],
                        "scenarios": {
                            "current_offer": 84.3,

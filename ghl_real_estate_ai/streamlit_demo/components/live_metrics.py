...
class LiveMetricsManager:
    ...
    def _render_response_times_chart(self):
        ...
        fig.add_hline(
            y=5, line_dash="dash", line_color="red", annotation_text="5-min Target", annotation_position="right"
        )
    ...
    def _render_commission_pipeline_chart(self):
        ...
        fig.add_trace(
            go.Bar(name="Potential", x=chart_data["months"], y=chart_data["potential"], marker_color="#fbbf24")
        )

        fig.add_trace(
            go.Bar(name="Confirmed", x=chart_data["months"], y=chart_data["confirmed"], marker_color="#3b82f6")
        )

        fig.add_trace(go.Bar(name="Paid", x=chart_data["months"], y=chart_data["paid"], marker_color="#10b981"))
    ...
    def _render_kpi_card(self, kpi: Dict[str, Any]):
        ...
        # Status colors
        status_colors = {"success": "#10b981", "warning": "#f59e0b", "error": "#ef4444"}

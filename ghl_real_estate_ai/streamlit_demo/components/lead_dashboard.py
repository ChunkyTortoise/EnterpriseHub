...
def render_lead_dashboard():
    ...
    with col_research:
        ...
        if st.session_state.research_active:
            research_steps = [('🔍 SOCIAL GRAPH ANALYSIS', 'Scanning target digital footprint...'), ('💰 FISCAL VERIFICATION', 'Validating pre-approval credentials...'), ('🧠 BEHAVIORAL MAPPING', 'Synthesizing interaction sentiment...'), ('📍 GEOGRAPHIC INTENT', 'Calibrating sector-specific gravity...')]
            import time

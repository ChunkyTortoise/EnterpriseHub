...
def render_proactive_intelligence_dashboard():
    ...
    alert_tab, predict_tab, coach_tab, monitor_tab = st.tabs(
        ["🚨 Smart Alerts", "🔮 Predictions", "💡 AI Coaching", "📡 Monitoring"]
    )
    ...
    with alert_tab:
        ...
        with col_control2:
            priority_filter = st.selectbox(
                "Filter by Priority:", ["All", "Critical", "High", "Medium", "Low", "Info"], index=0
            )
    ...
    with predict_tab:
        ...
        with pred_col1:
            prediction_type = st.selectbox(
                "Prediction Type:", ["General Insights", "Lead-Specific", "Market Trends", "Performance Forecast"]
            )
        ...
        if "predictive_insights_cache" in st.session_state:
            ...
            predictions_data = [
                ...
                },
                {
                    ...
                    "actions": [
                        "Increase lead gen budget 20%",
                        "Prepare additional inventory",
                        "Schedule extra showings",
                    ],
                },
            ]
    ...
    with coach_tab:
        ...
        with coach_col1:
            coaching_focus = st.selectbox(
                "Coaching Focus:", ["Communication", "Strategy", "Time Management", "Follow-up", "All Areas"]
            )
        ...
        if "ai_coaching_cache" in st.session_state:
            ...
            for insight in coaching_insights:
                ...
                effort_colors = {"Immediate": "#10b981", "Short-term": "#f59e0b", "Long-term": "#ef4444"}
...
def render_proactive_alerts_widget():
    ...
    # Quick alert summary
    alert_summary = {"critical": 0, "high": 2, "medium": 3, "total": 5}

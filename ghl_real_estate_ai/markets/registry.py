...
class MarketRegistry:
    ...
    def _validate_market_config(self, config: Dict[str, Any]) -> List[str]:
        ...
        required_appeal_scores = {
            'value_appeal', 'luxury_appeal', 'executive_appeal', 'commute_appeal',
            'family_appeal', 'startup_appeal', 'tech_appeal', 'business_appeal',
            'arts_appeal', 'convenience_appeal', 'lifestyle_appeal', 'sports_appeal',
            'culture_appeal', 'growth_appeal', 'healthcare_appeal', 'military_appeal',
            'tourism_appeal', 'sustainability_appeal'
        }
        ...
        for neighborhood in neighborhoods:
            ...
            if missing_appeals and len(missing_appeals) < len(required_appeal_scores):  # Only warn if partially complete

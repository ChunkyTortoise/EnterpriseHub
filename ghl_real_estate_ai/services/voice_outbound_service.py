...
class VoiceOutboundService:
    ...
    async def prepare_vapi_payload(self, lead_id: str, lead_data: Dict[str, Any], property_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "intelligence": {
                ...
                "psychology": {
                    "motivation": psychology.motivation_type if isinstance(psychology.motivation_type, str) else psychology.motivation_type.value,
                    "urgency": psychology.urgency_level if isinstance(psychology.urgency_level, str) else psychology.urgency_level.value
                }
            },
    ...
    async def trigger_vapi_call(self, customer_number: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        vapi_payload = {
            ...
            "assistantOverrides": {
                "variableValues": {
                    "first_message": payload["vapi_config"]["first_message"]
                },
                "serverMessages": [
                    {
                        "role": "system",
                        "content": payload["vapi_config"]["system_prompt"]
                    }
                ]
            }
        }

...
async def create_property_repository(
...
async def create_json_repository(
    repository_factory: "RepositoryFactory", config: Dict[str, Any]
) -> "IPropertyRepository":
...
async def create_mls_repository(
    repository_factory: "RepositoryFactory", config: Dict[str, Any]
) -> "IPropertyRepository":
...
async def create_rag_repository(
    repository_factory: "RepositoryFactory", config: Dict[str, Any]
) -> "IPropertyRepository":
...
async def create_hybrid_repository(
    repository_factory: "RepositoryFactory", config: Dict[str, Any]
) -> "IPropertyRepository":
...
async def create_mock_repository(
    repository_factory: "RepositoryFactory", config: Dict[str, Any]
) -> "IPropertyRepository":
...
def create_property_matcher_context(
    property_data_service: "PropertyDataService", scoring_factory: "ScoringFactory", config: Dict[str, Any]
    ...
    class PerformanceMonitor:
        ...
        def record_metric(self, name: str, value: float, tags: Optional[Dict[str, str]] = None):
            ...
            self.metrics[name].append(
                {"value": value, "tags": tags or {}, "timestamp": asyncio.get_event_loop().time()}
            )
        ...
        def health_check(self) -> Dict[str, Any]:
            ...
            return {"healthy": True, "metrics_count": len(self.metrics), "enabled": self.enabled}
...
def create_configuration_service(config: Dict[str, Any]) -> "ConfigurationService":
    ...
    class ConfigurationService:
        ...
        def health_check(self) -> Dict[str, Any]:
            ...
            return {"healthy": True, "config_keys": len(self._config)}

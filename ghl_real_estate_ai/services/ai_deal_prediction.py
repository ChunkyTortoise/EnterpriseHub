...
class DealPredictor:
    ...
    def _predict_close_date(self, deal_data: Dict, probability: float) -> Tuple[datetime, Tuple[datetime, datetime]]:
        ...
        stages_order = ["lead", "qualified", "showing", "offer", "negotiation", "contract", "closing"]
...
if __name__ == "__main__":
    ...
    print(f"   Date Range: {prediction.date_range_start.strftime('%Y-%m-%d')} to {prediction.date_range_end.strftime('%Y-%m-%d')}")

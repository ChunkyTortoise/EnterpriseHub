...
class RealTimeIntegration:
    ...
    def publish_lead_events(
        ...
        lead_id_field: str = "lead_id",
        data_field: str = "lead_data"
    ):
        """
    ...
    async def _safe_publish_conversation_update(
        ...
        await self.event_publisher.publish_conversation_update(conversation_id, lead_id, stage, None, user_id, location_id)

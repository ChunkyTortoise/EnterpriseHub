...
from ghl_real_estate_ai.services.proactive_intelligence_engine import ProactiveIntelligenceEngine, ProactiveAlert
...
class ComprehensiveAnalyticsEngine:
    ...
    async def _analyze_lead_intelligence_performance(
        ...
        try:
            ...
            funnel = await self.analytics_engine.get_conversion_funnel(
    ...
    async def _analyze_system_health(
        ...
        try:
            ...
            optimization_opportunities = self._identify_optimization_opportunities(
                component_scores, performance_trends
            )
    ...
    async def _calculate_roi_attribution(
        ...
        try:
            ...
            recommendations = self._generate_roi_recommendations(
                roi_by_component, cost_per_acquisition, ltv_impact
            )
    ...
    def _analyze_response_intelligence(self, location_id: str, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
    ...
    def _analyze_scoring_performance(self, location_id: str, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
    ...
    def _analyze_conversation_quality(self, location_id: str, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
    ...
    def _analyze_message_effectiveness(self, location_id: str, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
    ...
    def _analyze_engagement_patterns(self, location_id: str, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
    ...
    def _calculate_property_match_success(self, location_id: str, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
        """Calculate property matching success metrics."""
        return {
            "success_rate": 0.78,
            "avg_matches": 4.2,
            "viewing_conversion": 0.34,
            "offer_conversion": 0.18
        }

    def _analyze_lifestyle_dimensions(self, location_id: str, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
    ...
    def _analyze_preference_extraction(self, location_id: str, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
    ...
    def _calculate_agent_productivity(self, location_id: str, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
    ...
    def _analyze_agent_communication(self, location_id: str, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
    ...
    def _analyze_agent_conversion_performance(self, location_id: str, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
    ...
    async def _identify_coaching_opportunities(self, productivity: Dict, communication: Dict, conversion: Dict) -> List[Dict[str, Any]]:
...
# Export main class
__all__ = ["ComprehensiveAnalyticsEngine", "PerformanceMetric", "SystemHealthMetrics", "ROIAnalysis", "PredictiveInsight"]
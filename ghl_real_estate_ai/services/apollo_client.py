...
class ApolloClient:
    ...
    async def search_people(self, search_criteria: Dict[str, Any], limit: int = 25) -> List[PersonEnrichmentResult]:
        """
    ...
    async def calculate_lead_score(
        self, person_data: PersonEnrichmentResult, organization_data: OrganizationEnrichmentResult = None
    ) -> Dict[str, Any]:
        """
    ...
    async def batch_enrich_people(
        self, contacts: List[Dict[str, str]], batch_size: int = 10
    ) -> List[PersonEnrichmentResult]:
        """
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            test_response = await self._make_request("POST", "/emailVerifier", data={"email": "test@apollo.io"})

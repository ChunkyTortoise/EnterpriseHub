...
_STREETS = [
    "Baseline Rd", "Foothill Blvd", "Haven Ave", "Archibald Ave",
    "Carnelian St", "Hermosa Ave", "Sapphire St", "Amethyst Ave",
    "Rochester Ave", "Milliken Ave", "Church St", "Vineyard Ave",
    "Banyan St", "Terra Vista Pkwy", "Wilson Ave", "Lemon Ave",
]
...
_FIRST_NAMES = [
    ...
    "Jennifer", "David", "Elizabeth", "Carlos", "Rosa", "William",
]

_LAST_NAMES = [
    "Garcia", "Smith", "Johnson", "Rodriguez", "Martinez", "Williams",
    "Brown", "Davis", "Lopez", "Wilson", "Anderson", "Thomas",
]

...
class AdvancedDatabaseOptimizer:
    ...
    async def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'query_metrics': {
                ...
                'avg_query_time_ms': statistics.mean([m.avg_duration_ms for m in self.query_metrics.values()]) if self.query_metrics else 0,
            ...
            'health': {
                'score': health_score,
                'status': 'excellent' if health_score > 90 else 'good' if health_score > 75 else 'degraded' if health_score > 50 else 'poor'
            },
    ...
    async def get_optimization_recommendations(self) -> List[Dict[str, Any]]:
        ...
        slow_queries = [
            q for q in metrics['query_metrics']['queries'].values()
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        health['checks']['performance'] = {
            'status': 'pass' if metrics['health']['score'] > 75 else 'warn' if metrics['health']['score'] > 50 else 'fail',

...
class RanchoCucamongaAIAssistant(ClaudeAssistant):
                ...
                "alta_loma": {
                    ...
                    "employer_connections": {
                        "amazon": {
                            ...
                            "talking_points": [
                                "Peaceful environment for rest between shifts",
                ...
                "etiwanda": {
                    ...
                    "employer_connections": {
                        "amazon": {
                            ...
                            "talking_points": [
                                "New homes with modern features",
    ...
    async def generate_market_response(
        ...
        try:
            ...
            response = await self.generate_response(enhanced_prompt, conversation_history or [])
...
"""
    ...
    async def _generate_action_suggestions(
        self, context: RanchoCucamongaConversationContext, response: str
    ) -> List[Dict[str, Any]]:
    ...
    async def explain_ie_market_advantage(
        self, comparison_location: str = "Los Angeles", buyer_profile: str = "logistics_worker"
    ) -> str:

...
from ghl_real_estate_ai.services.ai_predictive_lead_scoring import PredictiveLeadScorer as AIPredictiveScorer
    ...
    def predict_conversion(self, contact_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if enriched_data.get("lead_score", 0) > 80:
            ...
            if not any("HIGH PRIORITY" in r["title"] for r in final_recommendations):
                final_recommendations.append({"title": "HIGH PRIORITY: Lead requires immediate attention", "type": "action"})

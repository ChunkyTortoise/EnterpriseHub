...
class SimpleDatabaseService:
    ...
    async def get_bot_performance_data(self, location_id: str = 'default', timeframe: str = '7d') -> List[Dict[str, Any]]:
    ...
    async def get_revenue_intelligence_data(self, location_id: str = 'default', timeframe: str = '30d') -> Dict[str, Any]:

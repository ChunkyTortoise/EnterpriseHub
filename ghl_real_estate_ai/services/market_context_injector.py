...
class MarketContextInjector:
    ...
    async def synthesize_price_reality_check(
        self, seller_expected_price: float, market_context: Dict[str, Any], tenant_id: Optional[str] = None
    ) -> str:
        """
        ...
        try:
            ...
            return (
                f"Based on recent sales, the median price in your area is around ${market_context['median_price']:,}."
            )

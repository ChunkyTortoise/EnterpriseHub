        ...
        try:
            ...
            if include_insights:
                insights = await self._generate_comprehensive_insights(
                    customer_data, intelligence_report
                )
            ...
            await self.cache.set(
                cache_key, 
                json.dumps(intelligence_report, default=str),
                ttl=cache_ttl
            )
            ...
            if "lead_score" in intelligence_report.get("scores", {}):
                ...
                if lead_score >= 80:
                    ...
                    recommendations.append({
                        ...
                        "actions": ["Enroll in nurturing sequence", "Provide educational content", "Monitor engagement"],
                        "priority": 3,

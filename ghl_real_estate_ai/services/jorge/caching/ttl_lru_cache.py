...
This module provides a production-grade caching implementation with:
...
class TTLLRUCache:
    ...
    Example:
        >>> cache = TTLLRUCache(max_entries=100, ttl_seconds=300)
        >>> cache.set("user_123", {"name": "John", "score": 85})

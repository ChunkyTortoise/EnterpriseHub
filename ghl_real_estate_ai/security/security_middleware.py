...
from .rbac import RoleManager, ResourceType, PermissionType
...
class SecurityMiddleware(BaseHTTPMiddleware):
    ...
    async def _detect_threats(self, request: Request, ip_address: str):
        ...
        sql_patterns = [
            ...
            "delete from", "' or '1'='1", "'; drop", "exec(", "script>"
        ]
        ...
        self._request_patterns[ip_address] = [
            req_time for req_time in self._request_patterns[ip_address]
        ...
        if suspicious_activity:
            ...
            if threat_type in ["sql_injection", "path_traversal", "potential_ddos"]:
                ...
                raise HTTPException(
                    status_code=status.HTTP_403_FORBIDDEN,
                    detail="Malicious activity detected"
                )
    ...
    def _map_endpoint_to_permission(self, path: str, method: str) -> tuple[Optional[ResourceType], Optional[PermissionType]]:

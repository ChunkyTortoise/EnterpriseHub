...
class RoleManager:
    ...
    def _initialize_system_roles(self):
        ...
        admin_resources = [
            ResourceType.USERS, ResourceType.LEADS, ResourceType.PROPERTIES,
            ResourceType.CONTACTS, ResourceType.CAMPAIGNS, ResourceType.REPORTS,
            ResourceType.ANALYTICS, ResourceType.WORKFLOWS, ResourceType.AUTOMATION,
            ResourceType.AI_MODELS, ResourceType.CLAUDE_ASSISTANT,
            ResourceType.PREDICTIVE_SCORING, ResourceType.BEHAVIORAL_ANALYSIS
        ]
        ...
        for resource, perm_type in agent_permissions:
            agent.add_permission(Permission(
        ...
        viewer_resources = [
            ResourceType.LEADS, ResourceType.CONTACTS, ResourceType.PROPERTIES,
            ResourceType.CAMPAIGNS, ResourceType.REPORTS, ResourceType.ANALYTICS
        ]
        
        for resource in viewer_resources:
            viewer.add_permission(Permission(
        ...
        api_user.add_permission(Permission(
            name="api_user_api_access",
            resource=ResourceType.API,
            permission_type=PermissionType.EXECUTE,
            scope="*"
        ))

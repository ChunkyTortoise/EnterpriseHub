...
__all__ = ["AzureMarketplace", "AzureAuthIntegration", "AzureDeployment", "AzureBilling"]

# Azure integration configuration
AZURE_CONFIG = {
    "target_revenue": 25_000_000,  # $25M ARR
    "marketplace_category": "Analytics",
    "saas_offer_types": ["per_user_monthly", "per_user_annual", "flat_rate_monthly", "flat_rate_annual"],
    "azure_services": [
        "Azure AD",
        "Azure App Service",
    ...
    "pricing_plans": {
        "starter": {"monthly_cost": 299, "annual_cost": 2999, "user_limit": 10},
        "professional": {"monthly_cost": 999, "annual_cost": 9999, "user_limit": 100},
        "enterprise": {"monthly_cost": 2999, "annual_cost": 29999, "user_limit": "unlimited"},
    },
}

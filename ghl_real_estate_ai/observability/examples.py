...
async def qualify_seller_with_detailed_tracing(state: Dict) -> Dict:
    ...
    async with async_workflow_span("seller_bot", "qualify_seller", contact_id=contact_id) as parent_span:
        # Add custom attributes
        parent_span.set_attribute("seller.property_address", state.get("property_address"))

        # Sub-span for FRS calculation
        async with async_workflow_span("seller_bot", "calculate_frs", contact_id=contact_id) as frs_span:
        ...
        async with async_workflow_span("seller_bot", "calculate_pcs", contact_id=contact_id) as pcs_span:
...
class IntentDecoderWithTracing:
    ...
    async def analyze_lead(self, contact_id: str, conversation_history: list) -> Dict:
        ...
        async with async_workflow_span("intent_decoder", "analyze_lead", contact_id=contact_id) as span:

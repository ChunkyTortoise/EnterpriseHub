...
def simulate_hit_list_seller(url, message="I'm interested in selling my house."):
    ...
    payload = {
        ...
        "message": {"type": "SMS", "body": message, "direction": "inbound", "timestamp": datetime.utcnow().isoformat()},
        "contact": {
            "firstName": "John",
            "lastName": "Seller",
            "phone": "+15125559999",
            ...
            "customFields": {"Primary Contact Type": "Seller", "disposition": "Hit List"},
        },
    }
...
def simulate_inactive_contact(url):
    ...
    payload = {
        ...
        "locationId": "loc_123",
        "message": {"type": "SMS", "body": "Just checking in.", "direction": "inbound"},
        "contact": {"firstName": "Jane", "lastName": "Doe", "tags": ["Untouched"], "customFields": {}},
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--type", type=str, choices=["seller", "inactive", "both"], default="both", help="Simulation type"
    )
    parser.add_argument(
        "--message", type=str, default="I'm interested in selling my house.", help="Custom message for seller"
    )

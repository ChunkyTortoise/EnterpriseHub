...
class EnhancedBotOrchestrator:
    ...
    async def orchestrate_conversation(self,
        ...
        try:
            ...
            if self.config.fallback_to_original:
                ...
                return await self._fallback_to_original(conversation_type, lead_id, lead_name, message, conversation_history)
    ...
    async def _orchestrate_seller_conversation(self, session: ConversationSession, message: str, intent_update: Optional[Dict]) -> Dict[str, Any]:
    ...
    async def _orchestrate_lead_sequence(self, session: ConversationSession, message: str, intent_update: Optional[Dict]) -> Dict[str, Any]:
    ...
    async def _update_session_state(self, session: ConversationSession, result: Dict[str, Any], intent_update: Optional[Dict]):
    ...
    async def _emit_orchestration_events(self, session: ConversationSession, result: Dict[str, Any], intent_update: Optional[Dict]):
    ...
    async def _fallback_to_original(self, conversation_type: str, lead_id: str, lead_name: str, message: str, conversation_history: List[Dict]) -> Dict[str, Any]:
    ...
    async def _fallback_jorge_conversation(self, lead_id: str, lead_name: str, conversation_history: List[Dict]) -> Dict[str, Any]:
...
async def publish_bot_orchestration_event(event_publisher, **kwargs):
    ...
    await event_publisher.publish_event(
        event_type="bot_orchestration_event",
        data=kwargs
    )

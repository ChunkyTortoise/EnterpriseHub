...
class HandoffManager:
    ...
    def has_valid_handoff_context(self, handoff_context: Optional[Any]) -> bool:
        """
        ...
        has_data = (
            getattr(handoff_context, "budget_range", None)
            or getattr(handoff_context, "conversation_summary", None)
            or getattr(handoff_context, "key_insights", None)
        )
    ...
    def populate_state_from_context(self, handoff_context: Any, initial_state: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if getattr(handoff_context, "urgency_level", None):
                ...
                urgency_map = {"immediate": 90, "urgent": 80, "ready": 70, "considering": 50, "browsing": 30}

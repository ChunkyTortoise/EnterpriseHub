...
@router.get("/bots/health", response_model=Dict[str, Any], status_code=status.HTTP_200_OK)
...
@router.post("/bots/{bot_id}/chat", response_model=None, status_code=status.HTTP_200_OK)
...
@router.post("/jorge-seller/start", response_model=Dict[str, Any], status_code=status.HTTP_200_OK)
...
@router.post("/lead-bot/{leadId}/schedule", response_model=Dict[str, Any], status_code=status.HTTP_200_OK)
...
@router.post("/jorge-seller/test", response_model=Dict[str, str], status_code=status.HTTP_200_OK)
...
@router.get("/performance/summary", response_model=Dict[str, Any], status_code=status.HTTP_200_OK)
...
@router.get("/performance/jorge", response_model=Dict[str, Any], status_code=status.HTTP_200_OK)
...
@router.get("/performance/lead-automation", response_model=Dict[str, Any], status_code=status.HTTP_200_OK)
...
@router.get("/performance/websocket", response_model=Dict[str, Any], status_code=status.HTTP_200_OK)
...
@router.get("/performance/health", response_model=Dict[str, Any], status_code=status.HTTP_200_OK)
...
@router.get("/jorge-seller/{lead_id}/progress", response_model=Dict[str, Any], status_code=status.HTTP_200_OK)
...
@router.get(
    "/jorge-seller/conversations/{conversation_id}",
...
@router.post("/jorge-seller/{lead_id}/stall-breaker", response_model=Dict[str, Any], status_code=status.HTTP_200_OK)

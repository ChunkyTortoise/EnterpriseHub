...
@router.get("/dependencies", response_model=Dict[str, Any], status_code=status.HTTP_200_OK)
...
@router.post("/alerts/test", response_model=Dict[str, Any], status_code=status.HTTP_200_OK)
...
@router.get("/status", response_model=None, status_code=status.HTTP_200_OK)
...
@router.get("/circuit-breakers", response_model=Dict[str, Any], status_code=status.HTTP_200_OK)
...
@router.get("/prometheus", response_model=None, status_code=status.HTTP_200_OK)

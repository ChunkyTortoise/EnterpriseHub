...
async def optimize_pricing(
    ...
    try:
        ...
        background_tasks.add_task(
            _track_pricing_optimization_event,
            pricing_result,
            location_id,
...
async def execute_campaign(
    ...
    try:
        ...
        executions = await revenue_optimizer.execute_triggered_campaigns(
            event_data, location_id
        )
        
        # Filter executions for this campaign
        campaign_executions = [
            ex for ex in executions if ex.campaign_id == campaign_id
        ]
...
async def get_revenue_analytics(
    ...
    try:
        ...
        analytics_data = await _calculate_revenue_analytics(
            location_id, start_date, end_date, metrics, segment_by
        )
        ...
        dashboard_data = {
            "overview": {
                ...
                "active_campaigns": len([
                    c for c in revenue_optimizer.active_campaigns.values() 

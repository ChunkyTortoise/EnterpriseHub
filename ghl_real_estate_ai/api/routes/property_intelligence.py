...
def generate_mock_property_analysis(request: PropertyAnalysisRequest) -> PropertyAnalysis:
    ...
    score_multiplier = {
        ...
        "PREMIUM": 0.92,
        "INSTITUTIONAL": 0.96
    }.get(request.analysisLevel, 0.85)
    ...
    condition = PropertyCondition(
        ...
        majorIssues=[
            "HVAC system requires attention (15+ years old)",
        ...
        systemsAnalysis={
            ...
            "plumbing": {
                "condition": "good",
                "issues": ["minor fixture wear"],
                "upgrade_needed": False
            },
            "roof": {
                "condition": "excellent",
                "age": 5,
                "warranty_remaining": 20
            },
            "foundation": {
                "condition": "excellent",
                "issues": [],
    ...
    analysis_time = {
        ...
        "PREMIUM": 15000,
        "INSTITUTIONAL": 25000
    }.get(request.analysisLevel, 8500)
...
def generate_mock_realtime_data(property_id: str):
    ...
    return {
        ...
        "marketActivity": {
            "recentSales": [
                {
                    "address": "445 Recent Sale St",
                    "price": 425000,
                    "date": "2025-01-20",
                    "sqft": 1850
                },
                {
                    "address": "567 Market Ave",
                    "price": 448000,
                    "date": "2025-01-18",
                    "sqft": 1920
                },
                {
                    "address": "890 Comparable Ln",
                    "price": 412000,
                    "date": "2025-01-15",
                    "sqft": 1780
                }
...
async def analyze_property(
    ...
    try:
        ...
        await event_publisher.publish_event("property_analyzed", {
...
async def delete_analysis(
    ...
    try:
        ...
        event_publisher = get_event_publisher()
        await event_publisher.publish_event("property_analysis_deleted", {
    ...
    try:
        ...
        comparison = PropertyComparison(
            properties=[
                {
                    ...
                    "risk": {
                        "overallRisk": "moderate" if i % 2 else "low",
                        "riskScore": 30 + (i * 5)
                    }
                }
            ...
            recommendation={
                ...
                "bestCashFlow": property_id_list[1] if len(property_id_list) > 1 else property_id_list[0] if property_id_list else "",
                "bestAppreciation": property_id_list[2] if len(property_id_list) > 2 else property_id_list[0] if property_id_list else "",

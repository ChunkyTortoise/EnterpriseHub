...
from ghl_real_estate_ai.core.llm_client import get_llm_client, TaskComplexity
...
class EvaluatorAgent:
    ...
    async def evaluate_response(self, response_text: str, context: Dict[str, Any], rubric_type: str = "general") -> Dict[str, Any]:
        """
...
"""
        ...
        try:
            ...
            return {
                ...
                "raw_response": eval_resp.content,
                "pass": False
            }

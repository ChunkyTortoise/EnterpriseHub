...
if TYPE_CHECKING:
    ...
    from ..realtime.monitoring_manager import ComplianceMetrics, RealTimeMonitoringManager
...
class ComplianceService:
    ...
    async def assess_compliance(
        ...
        compliance_status, violations = await self.policy_enforcer.check_compliance(model, context)
        ...
        compliance_score = self._calculate_compliance_score(risk_assessment, violations, model)
    ...
    def _calculate_compliance_score(
        ...
        total_deduction = sum(violation_deductions.get(v.severity.value, 5) for v in violations)
    ...
    async def get_compliance_summary(
        ...
        if model_id:
            ...
            return {
                ...
                "grade": ComplianceScore(overall_score=db_model.compliance_score.overall_score).grade
                if db_model.compliance_score
                else None,
    ...
    async def list_models(
        ...
        db_models = await self.model_repo.list_models(compliance_status=compliance_status, risk_level=risk_level)

...
class TestXGBoostConversionModel:
    ...
    async def test_prediction_error_handling(self, model):
        ...
        invalid_features = MLFeatureVector(
            email_open_rate=None, email_click_rate=None, response_velocity=None,
            conversation_depth=None, engagement_consistency=None,
            property_view_frequency=None, search_refinement_count=None,
            price_range_stability=None, location_focus_score=None, timing_urgency_signals=None,
            budget_clarity_score=None, financing_readiness=None, price_sensitivity=None,
            affordability_ratio=None, question_sophistication=None, decision_maker_confidence=None,
            family_situation_clarity=None, relocation_urgency=None, previous_interactions=None,
            conversion_funnel_stage=None, seasonal_patterns=None, market_conditions_score=None,
            communication_style_score=None, technical_sophistication=None, local_market_knowledge=None,
            data_completeness=None, recency_weight=None
        )

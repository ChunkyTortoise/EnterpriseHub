...
class TestABTestManager:
    ...
    def test_record_result(self):
        ...
        manager.record_result(exp_id, "a", {
            "contact_id": "c1",
            "conversion": True,
            "lead_score": 80
        })
    ...
    def test_analyze_experiment(self):
        ...
        for i in range(10):
            ...
            manager.record_result(exp_id, "b", {
                "contact_id": f"c{i+10}",
                "lead_score": 70 + i
            })
...
class TestConversationOptimizer:
    ...
    def test_suggest_next_question_hot_lead(self):
        ...
        assert any(word in suggestion["suggested_question"].lower() 
                  for word in ["schedule", "viewing", "appointment", "see"])

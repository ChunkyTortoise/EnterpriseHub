...
from ghl_real_estate_ai.services.workflow_marketplace import TemplateSortBy, WorkflowMarketplaceService
...
class TestTemplateInstaller(unittest.TestCase):
    ...
    def test_install_template(self):
        ...
        if templates:
            ...
            workflow = self.installer.install_template(template, tenant_id="test_user", customizations=customizations)
...
class TestTemplateManager(unittest.TestCase):
    ...
    def test_export_workflow(self):
        ...
        template = self.manager.export_workflow_as_template(
            workflow, metadata={"name": "Test Template", "category": "lead_nurturing"}
        )
    ...
    def test_validate_template(self):
        ...
        template = {
            ...
            "workflow": {"actions": [{"action_type": "send_sms"}]},
            "icon": "👋",
        }
    ...
    def test_customize_template(self):
        ...
        template = {"workflow": {"actions": [{"config": {"message": "Hi {{firstName}}, I'm {{agentName}}!"}}]}}

        customizations = {"firstName": "John", "agentName": "Sarah"}
...
class TestIntegration(unittest.TestCase):
    ...
    def test_complete_installation_flow(self):
        ...
        workflow = self.installer.install_template(
            details.__dict__, tenant_id="integration_test", customizations=customizations
        )
        self.assertIsNotNone(workflow)
        self.assertIn("workflow_id", workflow)

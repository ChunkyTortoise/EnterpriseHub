...
def main():
    parser = argparse.ArgumentParser(description="Test SMTP email alert channel")
    parser.add_argument("--mock", action="store_true", default=True, help="Run tests in mock mode (default: True)")
    parser.add_argument("--no-mock", action="store_true", help="Disable mock mode (send actual emails)")

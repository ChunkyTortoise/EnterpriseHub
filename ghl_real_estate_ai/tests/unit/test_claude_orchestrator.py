...
_init_mocks = {
    ...
    "ghl_real_estate_ai.core.mcp_servers.ontario_mills.analytics_intelligence_server.mcp": MagicMock(),
    "ghl_real_estate_ai.core.mcp_servers.ontario_mills.lead_intelligence_server.mcp": MagicMock(),
    "ghl_real_estate_ai.core.mcp_servers.ontario_mills.market_intelligence_server.mcp": MagicMock(),
    "ghl_real_estate_ai.core.mcp_servers.ontario_mills.negotiation_intelligence_server.mcp": MagicMock(),
    "ghl_real_estate_ai.core.mcp_servers.ontario_mills.property_intelligence_server.mcp": MagicMock(),

...
class GHLAPIClient:
    ...
    def health_check(self) -> Dict:
        ...
        try:
            ...
            return {"healthy": False, "error": str(e), "checked_at": datetime.now().isoformat()}
...
def get_jorge_client() -> GHLAPIClient:
    ...
    """
    return GHLAPIClient(api_key=JORGE_CREDENTIALS["api_key"], location_id=JORGE_CREDENTIALS["location_id"])

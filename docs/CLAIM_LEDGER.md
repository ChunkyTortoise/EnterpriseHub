...
| 8,212 tests are collectible/passing. | Local `pytest --collect-only --override-ini='addopts='` collected 7,665 tests on 2026-05-19. Targeted eval/orchestrator tests pass; some targeted health/security suites fail. | Credible but needs context | "Large test suite: 7,665 tests collected locally on 2026-05-19; targeted eval/orchestrator tests pass, with health/webhook suites still needing repair." |

...
class DocumentAutomationOrchestrator:
    ...
    def __init__(self, output_base_dir: str = None):
        ...
        self.docx_generator = create_docx_generator(output_dir=str(self.output_base / "docx"))
        self.pdf_generator = create_pdf_generator(output_dir=str(self.output_base / "pdf"))
        self.pptx_builder = create_pptx_builder(output_dir=str(self.output_base / "pptx"))
        self.xlsx_analyzer = create_xlsx_analyzer(output_dir=str(self.output_base / "xlsx"))
    ...
    async def generate_complete_client_package(
        self, client_data: Dict[str, Any], property_preferences: Dict[str, Any], package_type: str = "premium"
    ) -> Dict[str, Any]:
        """
        ...
        documents["client_proposal"] = {"path": proposal_path, "metadata": proposal_metadata, "time_saved_hours": 4}
        ...
        documents["property_report"] = {"path": report_path, "metadata": report_metadata, "time_saved_hours": 3}
    ...
    async def generate_jorge_demo_package(
        self, demo_scenario: str = "live_client_demo", include_analytics: bool = True
    ) -> Dict[str, Any]:
        """
        ...
        demo_spreadsheet_path, demo_spreadsheet_metadata = self.xlsx_analyzer.generate_lead_analytics_workbook(
            lead_data=demo_data["sample_leads"], time_period="demo_period", breakdown_by=["source", "score_range"]
        )
    ...
    async def generate_investor_package(
        self, investor_type: str = "venture_capital", funding_amount: int = 2000000
    ) -> Dict[str, Any]:
        """
        ...
        documents["pitch_deck"] = {"path": pitch_deck_path, "metadata": pitch_metadata, "time_saved_hours": 6}
        ...
        documents["executive_summary"] = {"path": exec_summary_path, "metadata": exec_metadata, "time_saved_hours": 3}
    ...
    async def _extract_live_data(
        self, client_data: Dict[str, Any], property_preferences: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        if self.lead_scorer and self.property_matcher:
            ...
            try:
                ...
                lead_result = await self.lead_scorer.score_lead(
                    lead_id=client_data.get("id", "demo_client"), context=property_preferences, tenant_id="demo_tenant"
                )

                # Find property matches
                property_matches = self.property_matcher.find_enhanced_matches(
                    preferences=property_preferences, limit=5, min_score=0.6
                )
                ...
                return {
                    ...
                    "property_matches": [
                        {"property": match.property, "score": match.overall_score, "reasoning": match.reasoning}
    ...
    async def _extract_investor_data(self, funding_amount: int) -> Dict[str, Any]:
        ...
        return {
            ...
            "market_analysis": {"tam_billions": 15.2, "sam_billions": 4.2, "som_millions": 500, "growth_rate": 0.28},
            "product_features": self._get_product_features(),
            "investment_assumptions": {
                "funding_amount": funding_amount,
                "burn_rate_monthly": 250000,
                "runway_months": 24,
                "target_metrics": {"arr_growth": 3.5, "customer_acquisition_cost": 1200, "lifetime_value": 15000},
            },
        }
    ...
    def _create_package_summary(
        self, documents: Dict[str, Any], client_data: Dict[str, Any], package_type: str
    ) -> Dict[str, Any]:
...
async def demo_document_automation():
    ...
    try:
        ...
        client_package = await orchestrator.generate_complete_client_package(
            client_data=demo_client, property_preferences=demo_preferences, package_type="premium"
        )

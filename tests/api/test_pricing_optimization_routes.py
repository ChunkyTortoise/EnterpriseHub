...
class TestPricingOptimizationRoutes:
    ...
    def test_calculate_lead_pricing_success(
        self, 
        client, 
        mock_user, 
        sample_pricing_request, 
        sample_pricing_result
    ):
    ...
    def test_calculate_lead_pricing_service_error(
        self, 
        client, 
        mock_user, 
        sample_pricing_request
    ...
    def test_get_pricing_analytics_with_date_range(self, client, mock_user):
        ...
        with patch('ghl_real_estate_ai.api.middleware.jwt_auth.get_current_user', return_value=mock_user), \
            ...
            mock_optimizer.return_value.get_pricing_analytics.assert_called_once_with(

...
class TestMobileProperties:
    ...
    def test_get_mobile_properties_basic(self, mock_auth):
        ...
        response = client.get("/api/mobile/properties", headers={"Authorization": "Bearer test_token"})
    ...
    def test_get_mobile_properties_with_location(self, mock_auth):
        ...
        response = client.get(
            ...
            params={"location": "30.2672,-97.7431", "radius": "25.0", "limit": "10"},
...
class TestMobileLeads:
    ...
    def test_get_mobile_leads_basic(self, mock_auth):
        ...
        response = client.get("/api/mobile/leads", headers={"Authorization": "Bearer test_token"})
...
class TestMobileAnalytics:
    ...
    def test_get_analytics_summary(self, mock_auth):
        ...
        response = client.get(
            "/api/mobile/analytics/summary", params={"period": "week"}, headers={"Authorization": "Bearer test_token"}
        )
...
class TestMobileSettings:
    ...
    def test_get_mobile_settings(self, mock_auth):
        ...
        response = client.get(
            "/api/mobile/settings", headers={"Authorization": "Bearer test_token", "X-Device-ID": "test_device_12345"}
        )
    ...
    def test_update_mobile_settings(self, mock_auth):
        ...
        response = client.put(
            ...
            headers={"Authorization": "Bearer test_token", "X-Device-ID": "test_device_12345"},
        )
...
class TestMobileSync:
    ...
    def test_mobile_sync_basic(self, mock_auth):
            ...
            "pending_operations": [
                {
                    "id": "op_001",
                    "type": "lead_update",
                    "data": {"lead_id": "lead_001", "status": "qualified", "notes": "Very interested"},
        ...
        response = client.post("/api/mobile/sync", json=sync_request, headers={"Authorization": "Bearer test_token"})
...
class TestMobileSearch:
    ...
    def test_mobile_search_properties(self, mock_auth):
        ...
        search_request = {
            ...
            "filters": {"max_price": 800000, "location": "Hill Country"},
            "location": {"latitude": 30.2672, "longitude": -97.7431, "accuracy": 10.0},
            "radius": 25.0,
            "sort_by": "relevance",
            "page": 1,
            "page_size": 20,
        ...
        response = client.post(
            "/api/mobile/search", json=search_request, headers={"Authorization": "Bearer test_token"}
        )
...
class TestMobileErrorHandling:
    ...
    def test_resource_not_found(self):
        ...
        response = client.get(
            "/api/mobile/properties/non_existent_property_id", headers={"Authorization": "Bearer test_token"}
        )

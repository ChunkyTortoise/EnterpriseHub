...
class TestARVisualizationSetup:
    ...
    def test_ar_visualization_without_auth(self, sample_visualization_request):
        ...
        response = client.post("/api/mobile/ar/visualize/setup", json=sample_visualization_request)
    ...
    def test_ar_visualization_validation(self):
        ...
        response = client.post(
            "/api/mobile/ar/visualize/setup", json=invalid_request, headers={"Authorization": "Bearer test_token"}
        )
...
class TestPropertyModels:
    ...
    def test_get_property_3d_model_not_found(self):
        ...
        response = client.get(
            f"/api/mobile/ar/property/{property_id}/model", headers={"Authorization": "Bearer test_token"}
        )
...
class TestSpatialAnchors:
    ...
    def test_create_spatial_anchor_success(self, mock_auth):
        ...
        response = client.post(
            "/api/mobile/ar/anchors/create", json=anchor_request, headers={"Authorization": "Bearer test_token"}
        )
    ...
    def test_create_spatial_anchor_validation(self):
        ...
        response = client.post(
            "/api/mobile/ar/anchors/create", json=invalid_anchor_request, headers={"Authorization": "Bearer test_token"}
        )
...
class TestSpatialMapping:
    ...
    def test_upload_spatial_mapping_success(self, mock_auth):
        ...
        mapping_data = {
            ...
            "lighting_estimation": {"ambient_intensity": 0.7, "main_light_direction": {"x": 0.5, "y": 0.8, "z": -0.3}},
            "tracking_quality": 0.85,
        }

        response = client.post(
            "/api/mobile/ar/mapping/upload", json=mapping_data, headers={"Authorization": "Bearer test_token"}
        )
    ...
    def test_upload_spatial_mapping_validation(self):
        ...
        response = client.post(
            "/api/mobile/ar/mapping/upload", json=invalid_mapping_data, headers={"Authorization": "Bearer test_token"}
        )
...
class TestDeviceCapabilities:
    ...
    def test_check_device_capabilities_ios(self):
        ...
        response = client.get(
            ...
            params={"device_type": "ios", "os_version": "17.0"},
            headers={"Authorization": "Bearer test_token"},
        )
    ...
    def test_check_device_capabilities_android(self):
        ...
        response = client.get(
            "/api/mobile/ar/capabilities/check",
            params={"device_type": "android", "os_version": "14.0"},
            headers={"Authorization": "Bearer test_token"},
        )
    ...
    def test_check_device_capabilities_hololens(self):
        ...
        response = client.get(
            "/api/mobile/ar/capabilities/check",
            params={"device_type": "hololens", "os_version": "10.0"},
            headers={"Authorization": "Bearer test_token"},
        )
    ...
    def test_check_device_capabilities_quest(self):
        ...
        response = client.get(
            "/api/mobile/ar/capabilities/check",
            params={"device_type": "quest", "os_version": "v55"},
            headers={"Authorization": "Bearer test_token"},
        )
    ...
    def test_check_device_capabilities_validation(self):
        ...
        response = client.get(
            "/api/mobile/ar/capabilities/check",
            params={"device_type": "invalid_device", "os_version": "1.0"},
            headers={"Authorization": "Bearer test_token"},
        )

...
from ghl_real_estate_ai.services.service6_ai_integration import (
    Service6AIResponse, MLScoringResult, CallAnalysis, 
    InferenceResponse, RequestPriority
)
...
class MockDatabaseService:
    ...
    async def update_lead_score(self, lead_id: str, score: float, 
...
class MockTwilioClient:
    ...
    async def make_call(self, to: str, from_number: str = None, 
                       twiml_url: str = None) -> Dict[str, Any]:
        call_data = {
...
class MockWebhookPayloads:
    ...
    def apollo_webhook(enrichment_data: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        return {
            ...
            'data': {**default_data, **(enrichment_data or {})}
        }
...
class MockMLScoringEngine:
    ...
    async def score_lead_comprehensive(self, lead_id: str, lead_data: Dict[str, Any]) -> MLScoringResult:
        ...
        score_data = self.mock_response_data if self.mock_response_data else {
            'final_ml_score': 85.5,
            'confidence_interval': [82.1, 88.9],
...
class MockPredictiveAnalytics:
    ...
    async def run_comprehensive_analysis(self, lead_data: Dict[str, Any], historical_context: List[Dict]) -> Dict[str, Any]:
    ...
    class ContentPersonalizationMock:
        async def generate_personalized_content(self, lead_id: str, lead_data: Dict[str, Any], content_type: str):
            ...
            return type('PersonalizedContent', (), {
...
class MockTieredCacheService(MockRedisClient):
    ...
    def setup_get_response(self, key: str, response_data: Any):
        ...
        self._storage[key] = json.dumps(response_data) if isinstance(response_data, (dict, list)) else str(response_data)

...
class TestEnterprisePerformanceOptimizer:
    ...
    async def test_ai_powered_optimization(self, optimizer, sample_performance_data):
        ...
        optimizer.claude_client.generate = AsyncMock(return_value=json.dumps({
    ...
    async def test_auto_scaling_logic(self, optimizer, sample_performance_data):
        ...
        optimizer.performance_monitor.collect_system_metrics = AsyncMock(return_value={
    ...
    async def test_optimization_history_tracking(self, optimizer):
        ...
        optimizer.intelligent_cache.redis_client.lrange = AsyncMock(return_value=[
    ...
    async def test_real_time_performance_dashboard(self, optimizer):
        ...
        optimizer.performance_monitor.collect_application_metrics = AsyncMock(return_value={
            'response_time': 180,
            'throughput': 1450
        })

...
class TestDynamicPricingOptimizer:
    ...
    async def test_roi_justified_pricing(self, optimizer, sample_context):
        ...
        result = await optimizer.calculate_lead_price(
            contact_id="high_value_lead",
            location_id="premium_location",
            context=sample_context
        )
    ...
    async def test_pricing_configuration_update(self, optimizer):
        ...
        result = await optimizer.update_pricing_configuration(
    ...
    async def test_price_adjustment_factors(self, optimizer, sample_context):
        ...
        high_urgency_result = await optimizer.calculate_lead_price(
            "contact1", "location1", high_urgency_context
        )
        
        low_urgency_result = await optimizer.calculate_lead_price(
            "contact2", "location1", low_urgency_context
        )

...
"""
Test suite for Rancho Cucamonga Market Service.

Tests comprehensive Rancho Cucamonga real estate market functionality including:
...
class TestRanchoCucamongaMarketService:
    """Test Rancho Cucamonga Market Service functionality."""

    @pytest.fixture
    def market_service(self):
        """Create market service instance for testing."""
        return RanchoCucamongaMarketService()
    ...
    def sample_property_listing(self):
        ...
        return PropertyListing(
            mls_id="RC2024001",
            address="123 Central Rancho Blvd, Rancho Cucamonga, CA 91730",
            price=725000,
            beds=3,
            baths=2.5,
            sqft=2100,
            ...
            photos=["photo1.jpg"],
            description="Modern home in Central Rancho",
    ...
    async def test_search_properties_neighborhood_filter(self, market_service):
        ...
        criteria = {"neighborhood": "Central Rancho"}

        properties = await market_service.search_properties(criteria, limit=5)

        for prop in properties:
            assert prop.neighborhood == "Central Rancho"
    ...
    async def test_get_neighborhood_analysis(self, market_service):
        ...
        assert isinstance(analysis, RanchoCucamongaNeighborhood)
    ...
    async def test_get_school_district_info(self, market_service):
        ...
        # Test known district
        district_info = await market_service.get_school_district_info("Rancho Cucamonga ISD")
    ...
    async def test_get_commute_analysis(self, market_service):
        ...
        property_coords = (30.252222, -97.763889)  # Central Rancho
        work_location = "Apple"
    ...
    def test_neighborhood_data_loading(self, market_service):
        ...
        expected_neighborhoods = ["round_rock", "ontario_mills", "south_lamar", "downtown"]
    ...
    def test_seasonal_factors_accuracy(self, market_service):
        ...
        assert "rancho_cucamonga_specific_factors" in seasonal_factors
    ...
    def test_singleton_pattern(self):
        """Test that get_rancho_cucamonga_market_service returns singleton."""
        service1 = get_rancho_cucamonga_market_service()
        service2 = get_rancho_cucamonga_market_service()
    ...
    def test_market_condition_logic(self, market_service):
        ...
        # Create test metrics
        from ghl_real_estate_ai.services.rancho_cucamonga_market_service import MarketMetrics
    ...
    async def test_concurrent_requests(self, market_service):
        ...
        tasks = [
            market_service.get_market_metrics("Victoria Gardens"),
            market_service.get_market_metrics("Round Rock"),
            market_service.get_neighborhood_analysis("Haven City"),
...
class TestRanchoCucamongaMarketServiceIntegration:
    """Integration tests for Rancho Cucamonga Market Service."""
    ...
    async def test_market_intelligence_pipeline(self, market_service):
        ...
        assert isinstance(neighborhood_analysis, RanchoCucamongaNeighborhood)
...
class TestRanchoCucamongaMarketServicePerformance:
    """Performance tests for Rancho Cucamonga Market Service."""

...
class TestGHLAdapter:
    ...
    @pytest.mark.asyncio()
    async def test_get_contact_not_found_returns_none(self, adapter: GHLAdapter) -> None:
    ...
    async def test_update_contact_success(self, adapter: GHLAdapter) -> None:
        ...
        with patch.object(adapter, "_request", new_callable=AsyncMock) as mock_req:
            mock_req.return_value = fake_resp
            result = await adapter.update_contact("ghl-003", {"first_name": "Updated", "email": "updated@example.com"})
    ...
    @pytest.mark.asyncio()
    async def test_search_contacts_returns_list(self, adapter: GHLAdapter) -> None:
    ...
    @pytest.mark.asyncio()
    async def test_sync_lead_applies_temperature_tag(self, adapter: GHLAdapter) -> None:
    ...
    @pytest.mark.asyncio()
    async def test_sync_lead_missing_contact(self, adapter: GHLAdapter) -> None:
    ...
    async def test_server_error_raises(self, adapter: GHLAdapter) -> None:
        ...
        with patch("ghl_real_estate_ai.services.crm.ghl_adapter.httpx.AsyncClient") as mock_client_cls:
...
class TestHubSpotAdapter:
    ...
    @pytest.mark.asyncio()
    async def test_create_contact_maps_fields(self, adapter: HubSpotAdapter) -> None:
    ...
    @pytest.mark.asyncio()
    async def test_get_contact_parses_response(self, adapter: HubSpotAdapter) -> None:
    ...
    @pytest.mark.asyncio()
    async def test_get_contact_not_found(self, adapter: HubSpotAdapter) -> None:
    ...
    @pytest.mark.asyncio()
    async def test_update_contact_sends_patch(self, adapter: HubSpotAdapter) -> None:
        ...
        with patch.object(adapter, "_request", new_callable=AsyncMock) as mock_req:
            mock_req.return_value = fake_resp
            result = await adapter.update_contact("hs-303", {"first_name": "Updated"})
        assert result.first_name == "Updated"
        call_args = mock_req.call_args
    ...
    @pytest.mark.asyncio()
    async def test_search_contacts_builds_filter(self, adapter: HubSpotAdapter) -> None:
    ...
    @pytest.mark.asyncio()
    async def test_delete_contact_success(self, adapter: HubSpotAdapter) -> None:
    ...
    @pytest.mark.asyncio()
    async def test_list_contacts_with_pagination(self, adapter: HubSpotAdapter) -> None:
        ...
        with patch.object(adapter, "_request", new_callable=AsyncMock) as mock_req:
            mock_req.return_value = fake_resp
            contacts, next_cursor = await adapter.list_contacts(limit=2, after=None)
    ...
    @pytest.mark.asyncio()
    async def test_auth_error_handling(self, adapter: HubSpotAdapter) -> None:

...
class TestMultiStrategyParsing:
    ...
    def test_parse_opportunities(self, orch):
        ...
        json_data = {
            "opportunities": [{"type": "upsell", "potential": "high"}, {"type": "referral", "potential": "medium"}]
        }
...
class TestCacheBehavior:
    ...
    def test_cache_key_generation(self, orch):
        ...
        req1 = ClaudeRequest(
            task_type=ClaudeTaskType.LEAD_ANALYSIS, context={"lead_id": "L1"}, prompt="Analyze this lead"
        )
    ...
    def test_cache_key_different_requests(self, orch):
        ...
        req2 = ClaudeRequest(
            task_type=ClaudeTaskType.LEAD_ANALYSIS, context={"lead_id": "L2"}, prompt="Analyze this lead"
        )
    ...
    def test_get_cached_response_expired(self, orch):
        ...
        orch._response_cache[cache_key] = ({"content": "expired response"}, past_time)
...
class TestPerformance:
    ...
    def test_cache_key_generation_performance(self, orch):
        ...
        req = ClaudeRequest(task_type=ClaudeTaskType.LEAD_ANALYSIS, context={"lead_id": "L1"}, prompt="Test prompt")

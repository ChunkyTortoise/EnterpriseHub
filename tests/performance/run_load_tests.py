    ...
    def run_smoke_test(self) -> Dict[str, Any]:
        ...
        try:
            cmd = [
                ...
                '-v',
                '-m', 'load',
                '-k', 'test_pricing_calculate_normal_load',
                '--tb=short'
            ]
    ...
    def run_peak_load_test(self) -> Dict[str, Any]:
        ...
        try:
            cmd = [
                ...
                '-v',
                '-m', 'load',
                '-k', 'test_pricing_calculate_peak_load',
                '--tb=short'
            ]
    ...
    def run_stress_test(self) -> Dict[str, Any]:
        ...
        try:
            cmd = [
                ...
                '-v',
                '-m', 'stress',
                '-k', 'test_pricing_calculate_stress_test',
                '--tb=short'
            ]
    ...
    def run_endurance_test(self) -> Dict[str, Any]:
        ...
        try:
            cmd = [
                ...
                '-v',
                '-m', 'endurance',
                '-k', 'test_sustained_load_endurance',
                '--tb=short'
            ]
    ...
    def run_capacity_test(self) -> Dict[str, Any]:
        ...
        try:
            cmd = [
                ...
                '-v',
                '-m', 'capacity',
                '-k', 'test_maximum_throughput_capacity',
                '--tb=short'
            ]
...
def main():
    parser = argparse.ArgumentParser(
        description="Jorge Platform Comprehensive Load Testing"
    )
    parser.add_argument(
        '--scenario',

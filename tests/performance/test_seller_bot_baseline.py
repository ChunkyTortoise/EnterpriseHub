"""Performance baseline tests for Seller Bot — process_seller_message().
...
def _generate_latencies(n: int, seed: int = 42) -> list:
    ...
    All within Seller Bot SLA (400 / 1800 / 2500).
    """
    rng = random.Random(seed)
    return [max(15.0, rng.lognormvariate(5.3, 0.6)) for _ in range(n)]


class TestSellerBotBaseline:
    """Performance baseline suite for Seller Bot process operation."""

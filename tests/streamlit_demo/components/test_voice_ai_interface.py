...
class TestVoiceAIInterface:
    ...
    def voice_interface(self):
        with patch(
            "ghl_real_estate_ai.streamlit_demo.components.voice_ai_interface.get_cached_voice_service"
        ) as mock_get_service:
    ...
    async def test_start_voice_session(self, voice_interface):
        ...
        voice_interface._start_voice_session("test_agent", VoiceInteractionType.LEAD_QUALIFICATION, "LEAD_123")

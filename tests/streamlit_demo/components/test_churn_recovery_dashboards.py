...
from ghl_real_estate_ai.streamlit_demo.components.advanced_churn_recovery_dashboard import (
    MarketMetrics, ChurnKPIs, load_churn_metrics, load_market_data,
    generate_recovery_pipeline_data, generate_campaign_performance,
    generate_geographic_data
)

from ghl_real_estate_ai.streamlit_demo.components.multi_market_analytics_view import (
    MarketPerformance, CrossMarketFlow, load_market_performance_data,
    generate_time_series_data, generate_cross_market_flows,
    get_health_class, get_trend_class
)

from ghl_real_estate_ai.streamlit_demo.components.roi_calculator_component import (
    InvestmentScenario, ChannelInvestment, ROICalculation, ROICalculator,
    get_investment_scenarios, get_channel_investments
)
...
class TestIntegrationTests:
    ...
    def test_component_import_structure(self):
        ...
        try:
            from ghl_real_estate_ai.streamlit_demo.components import advanced_churn_recovery_dashboard
            from ghl_real_estate_ai.streamlit_demo.components import multi_market_analytics_view
            from ghl_real_estate_ai.streamlit_demo.components import roi_calculator_component

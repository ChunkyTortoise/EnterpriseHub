...
class TestAdvancedCustomerIntelligenceDashboard:
    ...
    def dashboard(self):
        ...
        with patch('ghl_real_estate_ai.streamlit_demo.components.advanced_customer_intelligence_dashboard.AdvancedCustomerIntelligenceEngine'):
            with patch('ghl_real_estate_ai.streamlit_demo.components.advanced_customer_intelligence_dashboard.RealtimeNotificationEngine'):

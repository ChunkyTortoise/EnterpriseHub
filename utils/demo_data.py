    ...
    "MIAMI_LUXURY_BUYER": {
        ...
        "lead_data": {
            ...
            "conversation_history": [
                {
                    "role": "lead",
                    "message": "I'm interested in waterfront properties with direct ocean views.",
                    "timestamp": "2026-01-02 14:23",
                },
                {
                    "role": "agent",
                    "message": "Perfect timing! We have 3 exceptional oceanfront listings in your range. Would you prefer South Beach or Brickell?",
                    "timestamp": "2026-01-02 14:24",
                },
                {
                    "role": "lead",
                    "message": "South Beach preferred. What's available for March viewing?",
                    "timestamp": "2026-01-02 14:28",
                },
            ],
            "next_actions": [
    ...
    "DISTRESSED_SELLER": {
        ...
        "lead_data": {
            ...
            "conversation_history": [
                {
                    "role": "lead",
                    "message": "I need to sell fast. Bank gave me 60 days notice.",
                    "timestamp": "2026-01-04 09:15",
                },
                {
                    "role": "agent",
                    "message": "I understand the pressure. We specialize in quick closings. Can you share your property address so I can run a market analysis?",
                    "timestamp": "2026-01-04 09:17",
                },
                {
                    "role": "lead",
                    "message": "2340 NW 12th St. I owe $315k, think it's worth $400k.",
                    "timestamp": "2026-01-04 09:22",
                },
            ],
            "next_actions": [
    ...
    "RE_ENGAGEMENT_COLD": {
        ...
        "lead_data": {
            ...
            "conversation_history": [
                {
                    "role": "lead",
                    "message": "Nice property, but I'm not ready to buy yet. Just browsing.",
                    "timestamp": "2025-09-08 15:45",
                },
                {
                    "role": "agent",
                    "message": "No pressure! I'll send you market updates so you stay informed when you're ready.",
                    "timestamp": "2025-09-08 15:47",
                },
                {
                    "role": "agent",
                    "message": "[AUTO] New listings matching your criteria",
    ...
    "FIRST_TIME_BUYER": {
        ...
        "lead_data": {
            ...
            "conversation_history": [
                {
                    "role": "lead",
                    "message": "I'm a doctor finishing residency. How much do I need for a down payment?",
                    "timestamp": "2026-01-05 19:30",
                },
                {
                    "role": "agent",
                    "message": "Congratulations on finishing residency! Doctors qualify for special physician loan programs with 0% down. Let me explain...",
                    "timestamp": "2026-01-05 19:32",
                },
                {
                    "role": "lead",
                    "message": "That sounds perfect! What's the next step?",
                    "timestamp": "2026-01-05 19:45",
                },
            ],
            "next_actions": [
    ...
    "INVESTOR_PORTFOLIO": {
        ...
        "lead_data": {
            ...
            "conversation_history": [
                {
                    "role": "lead",
                    "message": "Send me anything with 8%+ cap rate and positive cash flow Day 1.",
                    "timestamp": "2025-12-28 11:20",
                },
                {
                    "role": "agent",
                    "message": "Got it. I have 2 fourplexes and 1 triplex that meet your criteria. All fully occupied with stable tenants. Sending pro formas now.",
                    "timestamp": "2025-12-28 11:23",
                },
                {
                    "role": "lead",
                    "message": "Fourplex looks good. Can you get me actual rent rolls?",
                    "timestamp": "2025-12-28 14:15",
                },
            ],
            "next_actions": [
...
def format_scenario_selector_options() -> Dict[str, str]:
    ...
    return {f"🎯 {data['name']} - {data['description']}": key for key, data in SCENARIOS.items()}

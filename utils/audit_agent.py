...
class AuditAgent:
    ...
    def __init__(self, target_name: str, tech_stack: str, compliance_needs: List[str], 
                 uploaded_file_content: Optional[str] = None, file_type: Optional[str] = None):
    ...
    def get_system_debt_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "debt_scores": [random.randint(10, 30), random.randint(20, 50), random.randint(5, 15), 
                           random.randint(40, 80), random.randint(15, 45), random.randint(30, 60)]
        }
            ...
            for pattern in patterns:
                ...
                if matches:
                    self.file_findings.append({
                        ...
                        "severity": "Critical" if category in ['hardcoded_credentials', 'public_access'] else "High",

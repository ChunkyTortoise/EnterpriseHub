...
class SEOTagGenerator:
    ...
    def generate_tags(self, gig_type: str, max_tags: int = 5, custom_keywords: Optional[List[str]] = None) -> List[str]:
        """
...
class DescriptionFormatter:
    ...
    def format_description(self, content: str, max_chars: int = None) -> str:
        """
    ...
    def validate_structure(self, content: str) -> Dict[str, bool]:
        ...
        """
        lines = content.split("\n")
        sections_found = {"hook": False, "problem": False, "solution": False, "cta": False}
...
class FAQGenerator:
    ...
    def generate_faqs(self, gig_type: str, count: int = 5, include_generic: bool = True) -> List[Dict[str, str]]:
        """
...
def main():
    ...
    if args.command == "tags":
        ...
        tags = generator.generate_tags(gig_type=args.gig_type, max_tags=args.max, custom_keywords=args.custom)
        ...
        faqs = generator.generate_faqs(gig_type=args.gig_type, count=args.count)

...
class Service6TestValidator:
    ...
    def run_unit_tests(self) -> Dict[str, any]:
        ...
        cmd = [
            ...
            "tests/fixtures/",
            "-m",
            "unit or not integration and not e2e",
            "--tb=short",
            "-v",
        ]
    ...
    def run_integration_tests(self) -> Dict[str, any]:
        ...
        cmd = [sys.executable, "-m", "pytest", "tests/integration/", "-m", "integration or e2e", "--tb=short", "-v"]
    ...
    def run_security_tests(self) -> Dict[str, any]:
        ...
        cmd = [sys.executable, "-m", "pytest", "tests/security/", "-m", "security", "--tb=short", "-v"]
    ...
    def _calculate_component_coverage(self, files: Dict) -> Dict[str, float]:
        ...
        return {"average": total_coverage / len(files), "files": file_coverages}
    ...
    def _analyze_critical_components(self, files: Dict) -> Dict[str, any]:
        ...
        critical_analysis = {"covered": {}, "missing": [], "below_threshold": {}}

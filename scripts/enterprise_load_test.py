...
class LoadTestRunner:
    ...
    def run(self):
        ...
        while time.time() - start_time < self.duration_seconds:
            ...
            print(
                f"   ⏳ {elapsed:.1f}s / {self.duration_seconds}s | Requests: {self.results['total_requests']}",
                end="\r",
            )
    ...
    def generate_report(self):
        ...
        report = {
            "test_config": {"concurrent_users": self.concurrent_users, "duration_seconds": self.duration_seconds},
            "summary": {

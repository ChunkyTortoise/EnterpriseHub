...
class DeploymentValidator:
    ...
    async def run_all_validations(self) -> Dict[str, Any]:
        ...
        for check_name, check_func in validation_checks:
            ...
            try:
                ...
                self.validation_results["checks"][check_name] = {"status": "ERROR", "error": error_msg}
    ...
    async def validate_market_configurations(self) -> Dict[str, Any]:
        ...
        result = {"status": "PASS", "validated_configs": [], "errors": [], "warnings": []}

        expected_configs = [
            "rancho_cucamonga.yaml",
            "dallas.yaml",
            "houston.yaml",
            "san_antonio.yaml",
            "rancho_cucamonga.yaml",
    ...
    async def validate_api_routes(self) -> Dict[str, Any]:
        ...
        result = {"status": "PASS", "route_files": [], "errors": []}

        # Check for key route files
        expected_routes = ["market_intelligence_v2.py", "jorge_advanced.py", "revenue_optimization.py"]
    ...
    async def validate_database_migrations(self) -> Dict[str, Any]:
        ...
        result = {"status": "PASS", "migration_files": [], "errors": []}
        ...
        multi_market_migrations = [
            f for f in migration_files if any(keyword in f.name.lower() for keyword in ["market", "churn", "revenue"])
        ]
    ...
    async def validate_service_dependencies(self) -> Dict[str, Any]:
        ...
        result = {"status": "PASS", "validated_services": [], "errors": []}
    ...
    async def validate_backward_compatibility(self) -> Dict[str, Any]:
        ...
        result = {"status": "PASS", "compatibility_checks": [], "warnings": []}
    ...
    async def validate_security(self) -> Dict[str, Any]:
        ...
        result = {"status": "PASS", "security_checks": [], "warnings": []}
    ...
    async def validate_performance_readiness(self) -> Dict[str, Any]:
        ...
        result = {"status": "PASS", "performance_checks": [], "recommendations": []}
    ...
    def generate_deployment_report(self) -> str:
        ...
        if self.validation_results["market_configs"]:
            report_lines.extend(["", "MARKET CONFIGURATIONS:", "-" * 40])
        ...
        report_lines.extend(["", "DEPLOYMENT RECOMMENDATIONS:", "-" * 40])
...
async def main():
    ...
    results_file = (
        validator.project_root / f"multi_market_validation_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    )
    with open(results_file, "w") as f:
        json.dump(results, f, indent=2)

    report_file = (
        validator.project_root / f"multi_market_deployment_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt"
    )

...
def run_stress_test():
    ...
    for i in range(50):
        prop = {
            ...
            "address": {"street": f"{random.randint(100, 9999)} Oak Street", "city": "Rancho Cucamonga"},
    ...
    leads = [
        ...
        {"id": "lead_budget", "name": "Budget Bob", "preferences": {"budget": 600000, "bedrooms": 3, "must_haves": []}},
        {
            "id": "lead_investor",
            "name": "Investor Ivy",
    ...
    for lead in leads:
        ...
        for m in top_matches:
            ...
            if m["price"] > lead["preferences"]["budget"] * 1.1:
                print(
                    f"    ⚠️ CRITICAL ERROR: Property ${m['price']} exceeds budget wiggle room for ${lead['preferences']['budget']}"
                )

...
try:
    ...
    from ghl_real_estate_ai.api.schemas.billing import SubscriptionTier, CreateSubscriptionRequest, SUBSCRIPTION_TIERS
...
class BillingIntegrationValidator:
    ...
    def test_environment_setup(self):
        ...
        self.log_test(
            ...
            else "Missing STRIPE_SECRET_KEY or STRIPE_WEBHOOK_SECRET",
        )
    ...
    def test_billing_service_initialization(self):
        ...
        try:
            ...
            self.log_test(
                "BillingService Initialization", billing_service is not None, "Service initialized successfully"
            )

            # Test error handling
            has_error_handling = hasattr(billing_service, "verify_webhook_signature")
            self.log_test("Error Handling Methods", has_error_handling, "Webhook verification method exists")

        except Exception as e:
            self.log_test("BillingService Initialization", False, f"Failed to initialize: {str(e)}")
    ...
    def test_subscription_manager_initialization(self):
        ...
        try:
            ...
            for method in required_methods:
                ...
                self.log_test(f"Method: {method}", has_method, "Available" if has_method else "Missing")

        except Exception as e:
            self.log_test("SubscriptionManager Initialization", False, f"Failed to initialize: {str(e)}")
    ...
    def test_billing_schemas(self):
        ...
        try:
            ...
            self.log_test("Billing Schemas", False, f"Schema validation failed: {str(e)}")
    ...
    def test_revenue_calculations(self):
        ...
        try:
            ...
            total_base_arr = sum(count * tiers[tier].price_monthly * 12 for tier, count in sample_distribution.items())
            ...
            self.log_test("Revenue Calculations", False, f"Calculation failed: {str(e)}")
    ...
    def test_dashboard_component_import(self):
        ...
        try:
            ...
            self.log_test(
                "Dashboard Component Import", callable(show), "Billing dashboard component imported successfully"
            )
            ...
            self.log_test("Dashboard Component Import", False, f"Import failed: {str(e)}")
    ...
    def test_api_routes_import(self):
        ...
        try:
            ...
            self.log_test("API Routes Import", routes_found >= 4, f"Found {routes_found}/4 expected billing routes")
    ...
    def test_webhook_integration_readiness(self):
        ...
        try:
            ...
            if webhook_file.exists():
                ...
                self.log_test("Webhook File Existence", False, "webhook.py file not found")

        except Exception as e:
            self.log_test("Webhook Integration Readiness", False, f"Check failed: {str(e)}")
    ...
    async def test_async_functionality(self):
        ...
        try:
            ...
            async_methods = ["get_active_subscription", "handle_usage_threshold", "get_usage_summary"]
            ...
            self.log_test("Async Functionality", False, f"Async test failed: {str(e)}")

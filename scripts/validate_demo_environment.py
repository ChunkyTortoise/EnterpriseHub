...
from ghl_real_estate_ai.services.client_demo_service import ClientDemoService, DemoScenario
...
async def main():
    ...
    try:
        ...
        # Determine exit code
        if all(isinstance(v, dict) and "error" not in v and all(v.values()) for v in results.values()):

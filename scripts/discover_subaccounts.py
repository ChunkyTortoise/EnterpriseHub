...
def discover_locations():
    ...
    headers_v1 = {"Authorization": f"Bearer {AGENCY_API_KEY}", "Content-Type": "application/json"}
    ...
    try:
        response = requests.get("https://rest.gohighlevel.com/v1/locations/", headers=headers_v1)

...
class PostDeploymentValidator:
    ...
    async def run_validation(self):
        ...
        for test_name, test_func in tests:
            ...
            try:
                ...
                self.validation_results["feature_tests"][test_name] = {"status": "ERROR", "error": error_msg}
    ...
    async def test_market_configurations(self):
        ...
        try:
            ...
            return {"status": "PASS", "markets_loaded": len(loaded_markets), "markets": loaded_markets}
    ...
    async def test_churn_recovery(self):
        ...
        try:
            from ghl_real_estate_ai.services.churn_prediction_engine import ChurnPredictionEngine, ChurnRiskTier
    ...
    async def test_feature_flags(self):
        ...
        try:
            ...
            required_flags = ["multi_market_expansion", "advanced_churn_recovery", "revenue_optimization"]
    ...
    async def test_backward_compatibility(self):
        ...
        try:
            ...
            test_contact = {"id": "test_123", "name": "Test Contact", "email": "test@example.com"}
            ...
            return {
                "status": "PASS",
                "tested_components": ["ClaudeAssistant", "GHLContact", "ContactData"],
    ...
    def generate_validation_report(self):
        ...
        if market_test and "markets" in market_test:
            report_lines.extend(["", "DEPLOYED MARKETS:", "-" * 40])
            for market_id, market_info in market_test["markets"].items():
                ...
                report_lines.append(
                    f"• {market_info['market_name']}: {neighborhoods} neighborhoods, {employers} employers"
                )
...
async def main():
    ...
    # Save results
    results_file = (
        validator.project_root / f"post_deployment_validation_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    )

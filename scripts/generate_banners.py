...
create_banner(
    1584,
    396,
    "portfolio/assets/images/linkedin-banner.png",
    "EnterpriseHub",
    "AI Technical Co-Founder | Agentic Workflows",
)
...
create_banner(
    1600,
    400,
    "portfolio/assets/images/upwork-banner.png",
    "Autonomous Agent Architect",
    "Building self-evolving AI systems that scale.",
)

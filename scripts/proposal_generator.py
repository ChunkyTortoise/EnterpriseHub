...
TEMPLATE_KEYWORDS = {
    ...
    "api": ["api", "rest", "fastapi", "endpoint", "backend", "integration", "webhook", "microservice", "service"],
    "consulting": [
        "consulting",
        "architecture",
        "design",
...
def score_tech_fit(description: str) -> int:
    ...
    partial_match = ["node.js", "typescript", "django", "flask", "react"]
...
Examples:
  ...
  ./proposal_generator.py --template rag     # Override template
    ...
    parser.add_argument(
        "--template",
        "-t",
        choices=["rag", "chatbot", "dashboard", "api", "consulting"],
